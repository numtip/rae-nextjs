#!/usr/bin/env python3
"""
Export energy data from DB to CSV for dashboard.
"""
import os
import csv
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "energy_electricity_2567-2568_v1.csv")
...
def backup_existing_file():
    ...
    try:
        ...
        backup_file = os.path.join(BACKUP_DIR, f"energy_electricity_2567-2568_v1_{timestamp}.csv")
        ...
        logging.warning(f"Permission error backing up file: {e}")
        return None
...
def export_to_csv():
    ...
    try:
        ...
        with open(OUTPUT_FILE, 'w', newline='', encoding='utf-8') as csvfile:
            fieldnames = ['year', 'month', 'month_idx', 'people', 'kwh', 'cost_baht', 'kwh_per_person']
            ...
            for row in rows:
                ...
                row_data = {
                    ...
                    'kwh_per_person': float(row['kwh_per_person'])
                }
...
def main():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('/home/rae_admin/joomla-greenoffice/ops/energy/energy_export.log'),
            logging.StreamHandler()
        ]
    )
    
    logging.info("Starting energy DB to CSV export")
